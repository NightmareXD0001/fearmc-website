...
const JoinServerModal = ({ isOpen, onClose }: JoinServerModalProps) => {
  ...
  return (
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md z-50 animate-float">
        <div className="glass-card rounded-xl overflow-hidden mx-4">
          {/* Header */}
          <div className="bg-fear-red p-4 relative">
